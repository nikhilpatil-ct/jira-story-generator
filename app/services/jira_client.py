...
def build_fields(story: JiraItem) -> dict:
...
async def create_issue(story: JiraItem) -> dict:
...
def build_update_fields(story: JiraItem) -> dict:
...
async def update_issue(key: str, story: JiraItem) -> dict:
    ...
    fields = build_update_fields(story)
